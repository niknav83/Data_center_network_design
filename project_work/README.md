...
10. [Приступаем к настрйке сети Overlay](#Приступаем-к-настрйке-сети-Overlay)
...
11. [Приступаем к настрйке ESI-LAGs](#Приступаем-к-настрйке-ESI-LAGs)
...
### Краткое описание работы текущей сети.
 ...
 - На указанной схеме между коммутаторами обозначенными как Spine-1, Spine-2, Leaf-5 и двумя маршрутизаторами R16 и R14 запусщена динамическая маршрутизация реализованная на OSPF.
