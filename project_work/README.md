...
5. [Физическая схема новой сети](#Физическая-схема-сети-новой-сети)
...
- При возростании трафика приходиться обновлять оборудование или агрегировать линки для обеспечения производительности ядра  сети.  Потому что весь трафик идет через ядро сети.
- При выходе из строя оборудования или линка между ними прозходит перестроение stp дерева, что может повлиять на стабильность работы сети или недоступности сегмента или всей сети.
